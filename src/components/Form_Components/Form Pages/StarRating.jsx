...
const StarRating = ({ pageData }) => {
    ...
    const [formState, setFormState] = useState(() => ({
        ...
        componentsMetaData: {
            ...
            stars: {
                val: pageData?.componentsMetaData?.stars?.val || defaultMetadata.stars.val,
                maxVal: defaultMetadata.stars.maxVal // Ensure maxVal is included
            },
        ...
        if (isInitialMount.current) {
            ...
            setFormState(prevState => ({
                ...
                componentsMetaData: {
                    ...
                    stars: {
                        val: pageData?.componentsMetaData?.stars?.val || prevState.componentsMetaData.stars.val,
                        maxVal: prevState.componentsMetaData.stars.maxVal // Maintain maxVal
                    },
    ...
    return (
        <>
            <div id="viewer" className="w-full px-20 space-y-4 pointer-events-none">
                ...
                <RvwStrViewer numStars={formState.componentsMetaData.stars?.val} starRatingColor={currentForm?.design?.starRatingColor} />
                <FrmBtn 
            ...
            <div id="controls" className="w-[27vw] p-4 h-[86.9vh] fixed bg-gray-100 bottom-0 -right-10 flex flex-col space-y-4 overflow-y-auto">
                ...
                />
                <RvwStrController
                    numStars={formState.componentsMetaData.stars?.val}
