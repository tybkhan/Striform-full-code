...
const OpinionScale = ({pageData}) => {
    ...
    const [formState, setFormState] = useState(() => ({
        ...
        componentsMetaData: {
            ...
            scale: {
                val: pageData?.componentsMetaData[0]?.scale?.val ?? defaultMetadata.scale.val
            },
            button: {
        ...
        if (isInitialMount.current) {
            ...
            setFormState(prevState => ({
                ...
                componentsMetaData: {
                    ...
                    scale: {
                        val: pageData?.componentsMetaData[0]?.scale?.val ?? prevState.componentsMetaData.scale.val
                    },
                    button: {
    ...
    return (
        <>
            <div id="viewer" className="w-full px-20 space-y-4 pointer-events-none">
                {formState.componentsMetaData[0]?.question?.val &&
                ...
                <FrmOpinion selectedNumber={formState.componentsMetaData[0]?.scale?.val}/>
                <FrmBtn text={formState.componentsMetaData[0]?.button?.val}/>
            </div>
            <div id="controls"
                 className="w-[27vw] p-4 h-[86.9vh] fixed bg-gray-100 bottom-0 -right-10 flex flex-col space-y-4 overflow-y-auto">
                ...
                <FrmOpinionController
                    selectedNumber={formState.componentsMetaData[0]?.scale?.val}
