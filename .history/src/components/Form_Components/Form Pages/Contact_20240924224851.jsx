...
const Contact = ({ pageData }) => {
    console.log("this is contact page data",pageData, typeof(pageData));
    ...
    const [formState, setFormState] = useState(() => ({
        ...pageData,
        componentsMetaData: {
            question: pageData.componentsMetaData[0]?.question,
            input: pageData.componentsMetaData?.input || defaultMetadata.input,
    ...
    return (
        <>
            <div className="p-4 pointer-events-none" id="viewport">
                <FrmQuestion text={formState.componentsMetaData.question?.text || ''} />
